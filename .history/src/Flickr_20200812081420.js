...
const Flickr = () => {
    ...
    const LoadMorePictures = () => {
        ...
        fetch('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=' + flickrapikey + `&tags=cars&per_page=${}&page=${pageNumber}&format=json&nojsoncallback=1`)
